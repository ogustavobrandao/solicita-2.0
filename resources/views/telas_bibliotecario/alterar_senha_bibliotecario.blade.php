        ...
        <div class="row justify-content-center">
            <div class="col-md-4 corpoRequisicao shadow">
                ...
                <div class="col-md-12 p-0">
                    <form action="{{  route('atualizar-senha-bibliotecario')   }}" method="POST">
                        @csrf
                        <div class="form-group">
                            ...
                            <div class="form-group row mb-0">
                                ...
                                <div class="col-md-6 " style="">
                                    <a style="background-color: var(--padrao); border-radius: 0.5rem; color: white; font-size: 17px" class="btn" href="{{route('perfil-bibliotecario')}}">Voltar</a>
                                </div>
